...
export function About() {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-blue-900 via-blue-700 to-blue-500 text-white">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full bg-blue-800 border border-yellow-400">
                <CardContent className="p-6">
                  <div className="flex items-center justify-center h-12 w-12 rounded-md bg-yellow-400 text-blue-900 mb-4 mx-auto">
