  ...
  Groom City
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            >
              <Link 
                href="/booknow"
                className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-blue-800 bg-black hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
              >
                Book Now
              </Link>
            </motion.div>
